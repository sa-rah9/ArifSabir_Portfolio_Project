...
const info = [
  {
    ...
    link: "tel:+447413074274", // Use 'tel:' for phone call
  },
  {
    icon: <FaEnvelope />,
    title: "Email",
    description: "rogerkhan2006@gmail.com",
    link: "mailto:rogerkhan2006@gmail.com", // Use 'mailto:' for email
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "60 St Elmo close Slough, Berkshire",
    link: "https://www.google.com/maps?q=60+St+Elmo+Close+Slough+Berkshire", // Use Google Maps URL
  },
];
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-[30px]">
          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            ...
            >
              <h3 className="text-4xl text-[#FFEA00]">Let&apos;s work together</h3>
